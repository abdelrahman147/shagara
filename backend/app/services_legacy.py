...
class Retriever:
    ...
    async def ollama(self, question: str, context: str) -> str | None:
        ...
        prompt = f"""You are shagara AI, a grounded rooftop gardening assistant.
Use only the supplied context. Do not use outside knowledge. If the answer is not supported, say you do not know.
Include source markers such as [S1] when making claims.
